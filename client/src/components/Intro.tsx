...
function Intro() {
  return (
    <div className='intro'>
      ...
      <img src={intropng} className="intro__img d-sm-none" alt='Dijital Gastronomi Platformu' />
      <img src={intropng_mobil} className="intro__img d-none d-sm-block" alt='Dijital Gastronomi Platformu' />
    </div>
  )
}
